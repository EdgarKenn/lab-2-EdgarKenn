...
2. ¿Qué sucede cuando el usuario ingresa un número que tiene menos de cinco dígitos? ¿Por qué? ¿Cuál es la salida cuando se ingresa 1763? R= En el caso de ingresar un número de 4 digitos, se imprimirán puros "0" por que el programa ya está asumiendo que el número a ingresar será de 5 digitos
